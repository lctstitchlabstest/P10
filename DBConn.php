...
class DBConn
{
  ...
  public static function OpenDB($dbname = "NSLS", $user = "root", $password = "", $host = "localhost")
  {
  ...
  {
    $results = null;
    if(!($results = $sthselect->fetch(PDO::FETCH_ASSOC)))  {
  ...
  public function GetAllSQLResults($sthselect)
  {
    $results = null;
